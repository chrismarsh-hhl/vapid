  ...
  get tree() {
    ...
    for (const tpl of templates) {
      ...
      for (const [, sectionAttrs] of Object.entries(parsed)) {
        ...
        tree[sectionName] = tree[sectionName] || {
          form: false,
          options: {},
          fields: {},
        };
        Object.assign(tree[sectionName].options, sectionAttrs.params);
        tree[sectionName].form =
          tree[sectionName].form || sectionAttrs.keyword === 'form';
        ...
        for (const [, fieldAttrs] of Object.entries(sectionAttrs.fields)) {
          ...
          tree[resolvedSection] = tree[resolvedSection] || {
            form: false,
            options: {},
            fields: {},
          };

          tree[resolvedSection].fields[fieldName] = {
            type: 'text',
            ...(tree[resolvedSection].fields[fieldName] || {}),
            ...fieldAttrs.params,
          };
