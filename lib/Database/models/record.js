...
const recordFunction = (sequelize, DataTypes) => {
  /**
      ...
      content: {
        ...
        validate: {
          ...
          async fields(content) {
            ...
            const errors = Object.entries(section.fields).reduce(
              (memo, [name, params]) => {
